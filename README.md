...
* **Command:** `bash script2.sh [package_name]`
...
* **Prerequisites:** Root/Sudo access may be required for specific log parsing (Script 4).
...
---
**Academic Submission** VIT University - OSS NGMC Capstone Project
